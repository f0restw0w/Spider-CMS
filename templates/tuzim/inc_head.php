...
<div class="warp">
	<header class="user-information">
        <div class="top-bar-area">
            <div class="marauto">
               <div class="l bar-left" style="color:#fff;">
        ...
        <div class="top-head">
            <div class="marauto">
                ...
                <ul class="r head-seach">
                    <li class="seach-bar">
                        <p class="bdr-span">
                            <input type="text" class="l seach-txt" id="seach-txt" onKeyDown="search_skip(this); if(event.keyCode==13) do_search();" value="<?php if(isset($_GET['q'])) echo $_GET['q'];?>"/>
                    ...
                    <?php //print_r($c->categories);
                        foreach($c->categories as $a){
                            if($a['parent_id']=='0'){//只输出顶级分类
                                ...
                                echo('<li><a href="'.$a['surl'].'" '.$style.'>'.$a['cname'].'</a></li>');
                            }
                        }
                    ?>
                    <li>
