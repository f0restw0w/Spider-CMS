...
<div class="bor-sty choiceness"><?php foreach($a['list'] as $k => $v){ if($k==0){
	...
	?>
<div class="l choice-left"><span class="title">专题精选</span>
<div class="p-img"><a href="<?php echo $v['surl'];?>"><img
	src="<?php echo $v['area_logo'];?>" class="p-img" /></a></div>
<a class="c-name" href="<?php echo $v['surl'];?>"><?php echo $v['title'];?></a><br />
<span class="c-info"><?php echo $v['area_html'];?></span></div>
<div class="r choice-right"><a class="more"
