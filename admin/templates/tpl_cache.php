...
<script language="javascript" type="text/javascript"
	src="templates/css/js/cache.js"></script>
...
<div class="right_body">
	<!-- 当前位置开始 -->
	<div class="snav">
		您的位置：<a href="frame.php">管理首页</a> » 清理缓存
	</div>
	...
	<div class="mbody">
		<div class="mt10">
			<a class="but2" href="javascript:void(0);"
				onclick="cache('category');">分类缓存</a> <a class="but2"
				href="javascript:void(0);" onclick="cache('url_rewrite');">伪静态缓存</a>
