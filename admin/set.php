...
function m__save() {
	...
	if (file_exists ( dirname ( __FILE__ ) . '/..' . SITE_PATH . 'cache/url_config' ))
		unlink ( dirname ( __FILE__ ) . '/..' . SITE_PATH . 'cache/url_config' );
	if (file_exists ( dirname ( __FILE__ ) . '/..' . SITE_PATH . 'cache/categories' ))
		unlink ( dirname ( __FILE__ ) . '/..' . SITE_PATH . 'cache/categories' );
	die ( '{"code":"0","msg":"配置成功"}' );
}
// 选择模版
function show() {
